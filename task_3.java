...
сообщение об ошибке
    assertEquals("Если пользователю из россии больше 18 или 18 лет, 
выводится true. Если меньше 18 лет, выводится false. Если пользователю из 
америки 21 год, выводится true." ,result, isAdult);
	}
}
